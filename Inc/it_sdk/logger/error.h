...
#define ITSDK_ERROR_CONFIG_SDKAPP_DEFAULT   0x00000074 | (ITSDK_ERROR_LEVEL_INFO  | ITSDK_ERROR_TYPE_SDK | ITSDK_ERROR_WITH_VALUE)	// The config has been restored to factory default (value bit 0 => SDK / bit 1 => APP)
