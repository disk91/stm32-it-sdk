...
#define ITSDK_ERROR_CONFIG_OVERRIDE_MISS    0x00000070 | (ITSDK_ERROR_LEVEL_ERROR | ITSDK_ERROR_TYPE_SDK | ITSDK_ERROR_WOUT_VALUE)	// The config function has not been overrided - no factory default for the app part
...
#define ITSDK_ERROR_DRV_ST25DV_NOTFOUND		0x00000310 | (ITSDK_ERROR_LEVEL_ERROR | ITSDK_ERROR_TYPE_SDK | ITSDK_ERROR_WOUT_VALUE)	// Device not fount on I2C
