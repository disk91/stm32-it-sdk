...
#define	ITSDK_ERROR_ADC_INIT_FAILED			0x00000005 | (ITSDK_ERROR_LEVEL_FATAL | ITSDK_ERROR_TYPE_SDK | ITSDK_ERROR_WITH_VALUE)
...
#define ITSDK_ERROR_EERPOM_WRITEFAILED		0x00000032 | (ITSDK_ERROR_LEVEL_ERROR | ITSDK_ERROR_TYPE_SDK | ITSDK_ERROR_WOUT_VALUE)  // Failure during EEPROM Write even
#define ITSDK_ERROR_EERPOM_NOPAGELEFT		0x00000033 | (ITSDK_ERROR_LEVEL_ERROR | ITSDK_ERROR_TYPE_SDK | ITSDK_ERROR_WOUT_VALUE)  // Failed to get free page to add EEPROM data
#define ITSDK_ERROR_EERPOM_OVERCYCLE		0x00000034 | (ITSDK_ERROR_LEVEL_ERROR | ITSDK_ERROR_TYPE_SDK | ITSDK_ERROR_WITH_VALUE)  // Indicated page has more cycle than expected limit with risk of being destroyed
#define	ITSDK_ERROR_EEPROM_NOTEXISTING		0x00000035 | (ITSDK_ERROR_LEVEL_ERROR | ITSDK_ERROR_TYPE_SDK | ITSDK_ERROR_WOUT_VALUE)	// Try to Read out of initilized eeprom virtual memory
#define ITSDK_ERROR_EERPOM_CLEARFAILED		0x00000036 | (ITSDK_ERROR_LEVEL_ERROR | ITSDK_ERROR_TYPE_SDK | ITSDK_ERROR_WOUT_VALUE)  // Failure during EEPROM Page clear
